...
export const seamlessHiringStrategicDecisions: StrategicDecision[] = [
  {
    title: "Modernize instead of rewrite",
    body:
  ...
  {
    title: "Structure workflows before introducing AI",
    body:
  ...
  {
    title: "Design for tomorrow's enterprise—not today's implementation",
    body:
  ...
  {
    title: "Build reusable patterns, not isolated screens",
    body:
