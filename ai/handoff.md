...
- **Anchor hero restyle (ADR-088):** `/anchor` navy gradient hero + scroll-spy side nav (merged onto main after #204; draft had collided as ADR-087 — renumbered to 088).
...
- **Branch:** `claude/review-repo-updates-x0kvz` (merge main + ADR-088 renumber)
- **Production:** https://johnohio.vercel.app
- **Observation start:** 2026-07-03
- **ADR impact:** ADR-088 (hero navy + side nav); ADR-087 prior (#204)
